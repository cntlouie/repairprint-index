...
export function mediaError(error: unknown): NextResponse {
  ...
  const allowed = new Set(["MEDIA_CONSENT_REQUIRED", "MEDIA_POLICY_VERSION_REQUIRED", "MEDIA_INTAKE_NOT_FOUND", "MEDIA_PURPOSE_ALREADY_USED", "MEDIA_SIZE_INVALID", "MEDIA_TYPE_MISMATCH", "MEDIA_BYTES_UNSUPPORTED", "MEDIA_CONTAINER_INVALID", "MEDIA_DECODE_FAILED", "MEDIA_DIMENSIONS_INVALID", "MEDIA_PROCESSING_FAILED", "MEDIA_UPLOAD_NOT_AVAILABLE", "MEDIA_FINALIZE_NOT_AVAILABLE", "MEDIA_CAPABILITY_REQUIRED", "MEDIA_CAPABILITY_INVALID", "MEDIA_CAPABILITY_SCOPE_INVALID", "MEDIA_CAPABILITY_EXPIRED", "MEDIA_UNAVAILABLE"]);
