...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    ...listModels().map((model) => ({ url: `${siteUrl}/brands/${model.brandSlug}/${model.modelSlug}`, changeFrequency: "weekly" as const, priority: 0.8 })),
    ...listRecentParts()
      .filter((part) => part.fitmentStatus !== "candidate_match" && part.fitmentStatus !== "disputed")
